...
// Se não tiver jogos, criar exemplos
if (Object.keys(customGames).length === 0) {
    const exemplo = {
        'exemplo-baseplate': {
            id: 'exemplo-baseplate',
            name: 'Baseplate Exemplo',
            creator: 'SandBlox',
            thumbColor: '#2ecc71',
            emoji: '🌍',
            description: 'Um baseplate simples para começar a construir!',
            createdAt: new Date().toISOString(),
            content: '_sandylocal_baseplate_cor_ 0x228B22',
            jsMechanics: null,
            exemplo: true
        },
        'exemplo-colorido': {
            ...
            thumbColor: '#e74c3c',
            emoji: '🌈',
            description: 'Um mundo cheio de cores e objetos',
            createdAt: new Date().toISOString(),
            content: `_sandylocal_baseplate_cor_ 0x2c3e50\n_gerar_boneco_local_id_ pos 0 1 0 cor 0xff0000 escala 1\n_gerar_boneco_local_id_ pos 5 1 0 cor 0x00ff00 escala 1.5`,
            jsMechanics: null,
            exemplo: true
        }
    };
    customGames = exemplo;
    Object.keys(exemplo).forEach(id => {
        gameStats[id] = { players: 0, likes: [], dislikes: [] };
    });
...
console.log(`📦 ${Object.keys(customGames).length} jogos carregados`);
...
// ============================================================
// FUNÇÃO PARA ENVIAR JOGOS PARA UM SOCKET
// ============================================================
...
io.on('connection', (socket) => {
    ...
    // Enviar TODOS os jogos para o novo usuário
    sendAllGames(socket);
